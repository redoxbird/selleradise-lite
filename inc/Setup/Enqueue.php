    ...
    public function get_data_for_javascript()
    {
        $data = [
            ...
            'langs' => [
                ...
                'header-search-form-label' => __("Search for products here...", "selleradise"),
                ...
                'mini-cart-item-text' => __("%d item is in your cart", "selleradise"),
                'mini-cart-items-text' => __("%d items are in your cart", "selleradise"),
                ...
                "%s has been added to your cart" => __("%s has been added to your cart", "selleradise"),
                "An error occurred while adding %s to your cart" => __("An error occurred while adding %s to your cart", "selleradise"),
                "An error occurred while updating cart" => __("An error occurred while updating cart", "selleradise"),
            ],
        ];
