...
<ul <?php if ($parent) : ?> x-show="activeChild == true" class="m-0 p-0 pl-3 w-full text-sm font-medium border-0 border-l-2 border-solid border-l-zinc-200" x-collapse <?php else : ?> class="m-0 px-page pb-12 w-full text-md min-h-[30rem]" <?php endif; ?>>
