...
$byline = sprintf(
    ...
    '<span class="author vcard"><a class="url fn n" href="' . esc_url(get_author_posts_url($id)) . '">' . esc_html(get_the_author()) . '</a></span>'
);
?>

<div class="selleradise_postCard__author">

  <?php if(get_avatar_url($id)): ?>
    <div class="selleradise_postCard__author-image">
      <img 
        src="<?php echo get_avatar_url($id); ?>" 
  ...
  <div class="selleradise_postCard__author-info">
    <a class="selleradise_postCard__author-name" href="<?php echo esc_url(get_author_posts_url($id)); ?>">
